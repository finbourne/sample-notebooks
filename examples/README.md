...
| [Transaction Type Consolidation.ipynb](<use-cases/ibor/Transaction%20Type%20Consolidation.ipynb>) | Transaction Type Consolidation Demo |  | instruments, portfolios, transaction types, transactions |
